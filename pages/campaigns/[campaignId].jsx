          ...
          <div className="w-[100%] h-[100%] flex flex-col items-center justify-start   ">
            <div className="w-[90%] h-[20%] flex flex-col items-start justify-start px-7 mt-[40px] -ml-[50px] ">
              ...
              <div className=" w-[100%] flex  items-start justify-start ">
                ...
                />
               {error!== "" &&  <span className=" text-red-700 text-[12px] font-bold ml-2">{error}</span>}
                </div>
                <GradientButton
                  title={"Donate"}
                  className={
              ...
              <div className="relative w-[98%] h-[100%] flex flex-col items-center justify-start  ">
                ...
                <div className=" w-[100%] min-h-[200px] bg-[#5B5B5B] rounded-[20px] flex flex-col items-center justify-start overflow-y-scroll scrollbar-hide">
                  {donations.map((item, i) => (
                    ...
                    >
                      <h1 className="font-Inter text-white">{`0x..${item?.donator.toString().slice(item?.donator.toString().length -10,item?.donator.toString().length)}`}</h1>
                      <h1 className="font-Inter text-white">{item?.amount ? ethers.utils.formatEther(item?.amount?.toString()):null}</h1>
                    </div>
                  ))}
                  {
                    donations.length === 0&& <h1 className="absolute top-1/2 left-[40%] text-white font-bold">No Donations yet</h1> 
                  }
                </div>
              </div>
            </div>
