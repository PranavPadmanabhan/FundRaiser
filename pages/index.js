  ...
  return (
    <div className='relative w-screen h-screen flex flex-col items-start justify-start bg-black pt-[20%] sm:pt-[15%] lg:pt-[10%] box-border'>
     ...
     <img 
      ...
      alt="illustration" 
      className='fixed z-[1] right-0 bottom-0 w-[100%] h-[60%] sm:w-[80%] sm:h-[60%] lg:w-[65%] lg:h-[88%] '
     />
     <div className="flex  flex-col items-start w-[90%] justify-start  pl-[12%] lg:pl-[5%]">
        ...
        <div className="flex  flex-col sm:flex-row  w-[100%] h-auto mt-[5%] lg:mt-[3%]">
          <GradientButton onClick={() => router.push('campaigns')} title={'Start a campaign '} className="z-[100] w-[55%] sm:w-[25%] lg:w-[18%] h-[5%] min-h-[35px] sm:min-h-[40px] lg:min-h-[45px] bg-gradient-to-r from-[#DA29E4] to-[#05B5E6] mr-0 sm:mr-[3%]" />
          <GradientButton title={'Donate Now '} className='z-[100] w-[40%] sm:w-[25%] lg:w-[15%] h-[5%] min-h-[35px] sm:min-h-[40px] lg:min-h-[45px] bg-gradient-to-r to-[#DA29E4] from-[#05B5E6] mt-[5%] sm:mt-0'/>
        </div>
     </div>
    </div>
  )
