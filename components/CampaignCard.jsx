...
const CampaignCard = ({image,title, amount, date,onClick,buttonTitle}) => {
  return (
    <div className='flex items-center justify-center w-[25vw]  min-w-[300px]  h-[80%] min-h-[55vh] lg:min-h-[75vh] lg:max-w-[320px] rounded-[20px] bg-gradient-to-r from-[#DA29E4] to-[#05B5E6] p-[3px] mt-[20px]'>
        <div className="w-[100%] h-[100%] bg-[#151515] rounded-[17px] flex flex-col items-center justify-start p-[4px]">
            <img src={image} alt="" className="w-[99%] h-[55%] rounded-[13px] " />
            ...
            <div className="flex items-center justify-start w-[100%] h-[10%] pl-[5%]">
                ...
                <span className="text-white ml-2 text-[3.2vw] sm:text-[2vw] lg:text-[1vw] text-center font-bold font-Inter">{date}</span>
            </div>
            <GradientButton 
              title={buttonTitle} 
